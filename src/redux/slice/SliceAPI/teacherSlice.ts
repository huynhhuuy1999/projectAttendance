...
import { doAddTeacher, doGetListTeacher, doGetOneTeacher, doUpdateTeacher } from "../../action/teacherAction";
...
const slice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(doGetListTeacher.fulfilled, (state, action: PayloadAction<Array<IResTeacher>>) => {
        ...
        builder.addCase(doGetOneTeacher.fulfilled, (state, action: PayloadAction<IResTeacher>) => {
            state.isLoading = false;
